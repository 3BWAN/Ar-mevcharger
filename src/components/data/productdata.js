...
Operating System	Android 7.0 / Android 10.0
Processor	
...
Display	9.7-inch TFT-LCD with 1536 x 2048 resolution & capacitive touch screen
Connectivity	
...
Storage Temperature	-20 to 60°C (-4 to 140°F)
Dimensions(W x H x D)	304.4 mm (11.98") x 227.8 mm (8.97") x 42.5 mm (1.67")
...
Protocols	DoIP, PLC J2497, ISO-15765, SAE-J1939, ISO-14229 UDS, SAE-J2411 Single Wire Can(GMLAN), ISO-11898-2, ISO-11898-3, SAE-J2819 (TP20), TP16, ISO-9141, ISO-14230, SAE-J2610 (Chrysler SCI), UART Echo Byte, SAE-J2809 (Honda Diag-H), SAE-J2740 (GM ALDL), SAE-J1567 (CCD BUS), Ford UBP, Nissan DDL UART with Clock, BMW DS2, BMW DS1, SAE J2819 (VAG KW81), KW82, SAE J1708, SAE-J1850 PWM (Ford SCP), SAE-J1850 VPW (GM Class2)
          ...
          tags: ['ID4 OBD2 Scanner', 'ID6 diagnostic scanner', 'ID4 diagnostic software', 'ID6 scanner', 'EQC EV Scanner', 'Mercedes-Benz EQC EV Scanner','Mercedes-Benz EQB EV Scanner','Autel 909EV']
...
`,
     ...
     {
          id: '53',
          name: 'ادابتر CCS2 إلى Tesla لشحن سيارات التسلا',
          currency: 'AED',
          price: 1350,
          tags: ['ادابتر ', 'CCS2', 'Tesla Fast', 'شاحن Tesla DC', 'شاحن CCS2', 'شاحن تسلا للبيع', 'شاحن CCS2 للبيع', 'شاحن تسلا منزلي', 'شاحن CCS2 منزلي', 'شاحن تسلا سريع', 'محول CCS2 إلى Tesla', 'CCS2 to Tesla Adapter'],
          flag: 'new',
          imageSource: require('../images/product-images/CCS2-TYPE2-TO-TESLA-1.jpg'),
          rating: 5,
          ratingCount: 1,
          description: "يمكنك هذا المحول من شحن سيارات تسلا  الأمريكية مثل موديل 3 وموديل اس وموديل اكس وموديل واي   Model y, Model 3,  Model Y  باستخدام الشواحن العامة السريعة ذات منفذ CCS2",
          longDescription: `يعتبر محول CCS2 إلى TESLA DC للسيارات الأمريكية في الخليج منتجًا مبتكرًا وفعالًا يهدف إلى توفير الامتثال والتوافق بين السيارات الأمريكية الشهيرة مثل موديل 3 وموديل اس وموديل اكس، Model 3،  Model Sوغيرها، مع شواحن الكهرباء العامة السريعة في المنطقة.
          ...
          في النهاية، يُعد محول CCS2 إلى TESLA  للسيارات الأمريكية في الخليج حلاً مثاليًا وموثوقًا لملاك السيارات الأمريكية الذين يرغبون في الاستفادة الكاملة من شبكة الشواحن العامة السريعة المتاحة والمساهمة في الحفاظ على البيئة في المنطقة.
`,
          function: 'DC adapter',
          illustration: require('../images/product-images/CCS2-TYPE2-TO-TESLA-5.jpg'),
          current:' 250 أمبير',
          operatingTemperature: '-30°C ~ 85°C',
          power: '200 كيلوواط',
          specialFeature: '',
        ...
        {
          id: '102',
          name: ' baba baba شاحن محمول تيار ثابت DC',
          currency: 'AED',
          price: 3500,
          tags: ['شاحن سيارة كهربائية جديد', 'شاحن سيارة كهربائية سريع', 'جرج سيارة كهربائية', 'شاحن GBT', 'شاحن متنقل', 'شاحن متنقل سريع', 'شاحن متنقل للسيارات الكهربائية', 'شاحن متنقل للسيارات الكهربائية', 'شاحن متنقل للسيارات الكهربائية', 'شاحن متنقل للسيارات الكهربائية', 'شاحن متنقل للسيارات الكهربائية', 'شاحن متنقل للسيارات الكهربائية', 'شاحن متنقل للسيارات الكهربائية', 'شاحن متنقل للسيارات الكهربائية'],
          flag: 'new',
